...
class RepresentativeShipmentRejectedBody extends StatefulWidget {
  ...
  @override
  State<RepresentativeShipmentRejectedBody> createState() =>
      _RepresentativeShipmentRejectedBodyState();
}

class _RepresentativeShipmentRejectedBodyState
    extends State<RepresentativeShipmentRejectedBody> {
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 25),
                        RepresentativeShipmentRejectReport(),
