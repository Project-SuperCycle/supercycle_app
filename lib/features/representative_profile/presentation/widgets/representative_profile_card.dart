...
import '../../../sales_process/presentation/views/sales_process_view.dart';

class RepresentativeProfileCard extends StatelessWidget {
  const RepresentativeProfileCard({super.key});
