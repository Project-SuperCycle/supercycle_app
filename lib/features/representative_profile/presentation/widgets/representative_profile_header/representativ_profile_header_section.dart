...
import 'package:supercycle_app/features/representative_profile/presentation/widgets/representative_profile_header/profile_header_navigation.dart';
import 'package:supercycle_app/features/representative_profile/presentation/widgets/representativ_profile_image.dart';

class RepresentativProfileHeaderSection extends StatelessWidget {
  const RepresentativProfileHeaderSection({
    super.key,
          ...
          child: Row(
            ...
            children: [
              Column(
                children: [
                  Text(
                    representativeProfileData.weeklyShipments.toString().padLeft(2, '0'),
                    style: const TextStyle(
              ...
              Column(
                children: [
                  Text(
                    representativeProfileData.totalShipments.toString().padLeft(2, '0'),
                    style: const TextStyle(
                      color: Color(0xFF4CAF50),
                      fontSize: 32,
                      fontWeight: FontWeight.bold,
