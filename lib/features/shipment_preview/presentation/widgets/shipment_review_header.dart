...
import 'package:supercycle_app/features/shipment_preview/presentation/widgets/images_preview_dialog.dart';

class ShipmentReviewHeader extends StatelessWidget {
  const ShipmentReviewHeader({super.key, required this.shipment});
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        ...
        const Spacer(),
        GestureDetector(
          onTap: () => _showImagesPreview(context, images: shipment.images),
          child: Container(
            width: 80,
            height: 80,
  ...
  void _showImagesPreview(BuildContext context, {required List<File> images}) {
    if (images.isEmpty) {
